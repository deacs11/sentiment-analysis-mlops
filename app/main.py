...
# --- Definisci le metriche che vuoi tracciare ---
...
# --- NUOVO: Aggiungi l'endpoint /metrics ---
@app.route('/metrics')
def metrics():
    # --- 3. MODIFICA QUESTA FUNZIONE ---
    # Usa Response per impostare il Content-Type corretto che Prometheus si aspetta
