...
import os
import sys
# Aggiungiamo la cartella principale al path per importare l'app
...
class TestApi(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Quando Jenkins eseguirà i test, l'API sarà in un container.
        # Per ora, per testare in locale, l'API deve essere in esecuzione.
